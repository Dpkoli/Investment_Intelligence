...
st.markdown(
    ...
    /* ── Channel inputs (tables, snaps): visually hidden but focusable ─────── */
...
(function(){
  ...
  new MutationObserver(function(mutations) {
    ...
    st.markdown(
        ...
        f"<div style='width:40px;height:40px;border-radius:10px;background:#071D35;"
        f"display:flex;align-items:center;justify-content:center;flex-shrink:0'>"
        f"<svg width='22' height='22' viewBox='0 0 32 32' fill='none'>"
        f"<polyline points='3,24 9,17 14,20 20,12 28,7' stroke='#1AB868' "
        f"stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round'/>"
        f"<circle cx='28' cy='7' r='2.5' fill='#1AB868'/>"
        f"</svg></div>"
        f"<h1 style='margin:0;color:#071D35;font-weight:700;font-size:2.1rem;"
        f"letter-spacing:-0.02em'>Invest"
